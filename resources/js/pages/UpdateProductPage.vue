    ...
    const fetchProductData = async () => {
        try {
            ...
            if (data.success) {
                ...
                formData.value.description = data.data.description;
                formData.value.brand_id=data.data.brand_id;
                formData.value.categories = data.data.category.map(element=>element.category_id)
                formData.value.specAreas = data.data.product_spec_areas.map(element=>element.spec_area_id)
                
                if(data.data.has_accesrorypdf === 1){
