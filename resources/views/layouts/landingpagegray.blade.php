...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>GUGA</title>
        <meta name="description" content="Somos una empresa comprometida con ofrecer a todos los médicos material de la más alta calidad.">
        <meta name="keywords" content="guga,equipo médico, autoclaves, arcos en C, esterilizadores, mantenimiento médico, equipo industrial, Guga Equipos y Servicios">
