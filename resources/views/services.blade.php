                ...
                <div id="carousel-1" class="relative min-w-[80%] max-w-full h-[20rem] bg-white rounded-2xl  overflow-hidden" data-carousel="slide" data-carousel-interval="5000">
                    ...
                    <div class=" w-full h-[20rem]  overflow-hidden">
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/1.jpeg" class=" block w-full h-full  object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/2.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/3.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/4.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/5.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/6.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/7.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/8.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/9.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 max-w-[70rem] w-full">
            <div class="flex items-center justify-center">
                ...
                <div id="carousel-2" class="relative min-w-[80%] max-w-full h-[20rem] bg-white rounded-2xl  overflow-hidden" data-carousel="slide" data-carousel-interval="5500">
                    ...
                    <div class=" w-full h-[20rem]  overflow-hidden">
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/10.jpeg" class=" block w-full h-full  object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/11.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/12.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/13.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/14.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/15.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/16.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
                        <div class="hidden duration-1000 ease-in-out" data-carousel-item>
                            <img src="/img/services/17.jpeg" class=" block w-full h-full object-cover bg-white " alt="...">
                        </div>
                    </div>
                    <!-- Slider indicators -->
                    <div class="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-3 rtl:space-x-reverse">
