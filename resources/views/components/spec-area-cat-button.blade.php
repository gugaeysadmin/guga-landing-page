...
<a href="{{ $href }}" class="cursor-pointer flex flex-col transition-transform duration-300 hover:-translate-y-5 hover:border-white group">
    <div class="my-0 py-0 rounded-full border-2 border-white group-hover:border-[3px] m-auto">
        <img src="/storage/{{ $image }}" alt="esterilization_icon" class="w-28 h-28 my-0 py-0 rounded-full"/>
    </div>
    <div class="text-center mx-7 mt-3">
        <p class="text-[1.1rem] max-w-32 text-white font-sans font-medium">{{ $text }}</p>
        {{-- <i class="bi bi-caret-down-fill text-[#0392ceff] group-hover:text-blue-600"></i> --}}
    </div>
</a>